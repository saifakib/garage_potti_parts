...
export class BrandsRepository {
  ...
  async findAll({
    ...
    try {
      ...
      return paginate(this.database.brands, { where, orderBy, ...args }, { page, perPage });
    } catch (error) {
      throw error;
    }
  }
  ...
  async update({ where, args }: { where?: Prisma.BrandsWhereUniqueInput; args?: Prisma.BrandsUpdateInput }) {
    try {
