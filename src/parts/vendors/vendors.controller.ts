...
import {
  ...
  UpdateVendorDto,
  updateVendorSchema,
} from '@/validationSchema/parts/Vendors';
...
export class VendorsController {
  ...
  async update(
    ...
    @Body(new ZodPipe(updateVendorSchema)) payload: UpdateVendorDto,
  ) {
    try {
      const response: any = await this.vendorsService.update(uuid, payload);
      return this.res.successResponse({
        data: response,
